...
import com.example.telusko.spring_aibrain_backend.model.*;
import com.example.telusko.spring_aibrain_backend.repository.TokenRepository;
...
public class AuthService {
    ...
    public ResponseEntity<AuthResponse> register(RegisterRequest request){
        ...
        userRepo.save(user);
         accessToken = jwtService.generateAcesssToken(request.getEmail());
    ...
    public ResponseEntity<AuthResponse> loginVerify(LoginRequest loginRequest){
        ...
        if(authentication.isAuthenticated()){
            accessToken = jwtService.generateAcesssToken(loginRequest.getEmail());
